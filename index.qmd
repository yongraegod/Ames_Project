...
sns.heatmap(top_10_corr_matrix, annot=True, fmt=".2f", cmap='coolwarm', vmin=-1, vmax=1, annot_kws={"size": 7})
plt.title("Top 10 Features Correlation Heatmap with Sale Price")
plt.axis('tight')
